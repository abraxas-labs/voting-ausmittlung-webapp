...
export class ProportionalElectionDoubleProportionalResultComponent implements OnDestroy, HasDeactivate {
  ...
  public politicalBusinessUnionContextDependentPathPrefix: string = '';
  ...
  constructor() {
    this.routeSubscription = this.route.params.subscribe(({ politicalBusinessId, politicalBusinessUnionId }) => {
      this.hasPoliticalBusinessUnionContext = !!politicalBusinessUnionId;
      this.politicalBusinessUnionContextDependentPathPrefix = this.hasPoliticalBusinessUnionContext ? '../../' : '';
